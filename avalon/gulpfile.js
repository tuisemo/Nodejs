...
gulp.task('fileinclude', ['cssmin'], function() {
    gulp.src('./bulid/*.html')
        .pipe(inject(gulp.src(['./bulid/css/normalize.css', './bulid/css/uikit.css', './bulid/css/layer.css', './bulid/css/style.css'], { reda: false }), { starttag: '<!-- inject:base:{{ext}} -->', relative: true }))
